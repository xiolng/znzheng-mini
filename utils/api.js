...
module.exports = {
  ...
  loginsuccess: function (app) {
    return (app.globalData.userInfo != null && typeof(app.globalData.userInfo.openid) != 'undefined' && app.globalData.userInfo.openid != undefined && app.globalData.userInfo.openid.length >= 28)
  },
  ...
  ConfirmAuth: function () {
    wx.getSetting({
      success: function (res) {
        if (res.authSetting[ 'scope.userInfo' ] && (app.globalData.userInfo && app.globalData.userInfo.openid)) {
